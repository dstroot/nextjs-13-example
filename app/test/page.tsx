    ...
    <>
      ...
      <div className="relative">
        <header className="relative z-50 flex flex-col pointer-events-none">
          ...
          <div className="top-0 order-last pt-3 -mb-3 sm:px-8">
                ...
                <div className="max-w-2xl mx-auto lg:max-w-5xl">
                  <div className="top-[var(--avatar-top,theme(spacing.3))] w-full">
                    <div className="relative">
                      <a
                        aria-label="Home"
                        className="block w-16 h-16 origin-left pointer-events-auto"
                        href="/"
                      >
                        <Image
                          className="object-cover w-16 h-16 rounded-full bg-zinc-100 dark:bg-zinc-800"
                          src="/img/avatar.webp"
